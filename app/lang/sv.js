const LANG_SV = {
    ...
    tutorial_share_text: "Använd den här knappen för att kopiera en länk med aktuell zoom, centrum och kartlager. Om ett uppladdat GPX-spår är aktivt öppnar länken även det delade spåret.",
